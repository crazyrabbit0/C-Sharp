...
public class TrayRunner : Form
{
    ...
    private void InitializeApp(string[] args)
    {
        ...
        {
            targetExe = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "cli-proxy-api-plus.exe");
            targetArgs = "";
        }

        logFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "cli-proxy-api-plus-tray.log");
